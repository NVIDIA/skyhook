...
func (in *BatchProcessingState) DeepCopyInto(out *BatchProcessingState) {
	*out = *in
	if in.CurrentBatchNodes != nil {
		in, out := &in.CurrentBatchNodes, &out.CurrentBatchNodes
...
func (in *SkyhookStatus) DeepCopyInto(out *SkyhookStatus) {
	*out = *in
	...
	if in.CompartmentBatchStates != nil {
		in, out := &in.CompartmentBatchStates, &out.CompartmentBatchStates
		*out = make(map[string]BatchProcessingState, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
