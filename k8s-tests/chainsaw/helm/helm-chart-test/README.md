...
6. Apply a DeploymentPolicy and NodeWright
7. Verify the NodeWright completes successfully
8. Uninstall the Helm chart (verifies pre-delete hook cleans up NodeWright/DeploymentPolicy resources automatically)
...
- End-to-end nodewright processing with Helm-deployed operator
- Automatic cleanup of NodeWright and DeploymentPolicy resources during helm uninstall
